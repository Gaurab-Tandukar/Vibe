    ...
    <>
      ...
      >
        <div
          ...
          style={{ maxWidth: "1080px", zIndex: 1 }}
        >
          <div className="text-center mb-5">
            ...
            <p
              ...
              style={{ maxWidth: "580px", fontSize: "1.05rem" }}
            >
              Have a question about Vibe, discovered a bug, or want to
              contribute? Our team is here to help you get connected.
            </p>
          </div>
            ...
            <div className="col-12 col-lg-5 d-flex flex-column justify-content-between">
              ...
              >
                  ...
                  <div className="d-flex flex-column gap-4">
                    <div className="d-flex align-items-start gap-3">
                      ...
                      <div>
                        ...
                        <a
                          href="mailto:gaurabtandukar20@gmail.com"
                          className="text-secondary text-decoration-none small"
                        >
                          gaurabtandukar20@gmail.com
                        </a>
                      </div>
                    </div>
                ...
                <div className="mt-4 pt-4 border-top">
                  <span className="small text-muted d-block mb-2 fw-medium">
                    Connect on Socials
                  </span>
                  <div className="d-flex gap-2">
                    ...
                    <a
                      href="https://www.linkedin.com/in/gaurab-tandukar-394592315/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="btn btn-sm btn-light rounded-circle p-0 d-flex align-items-center justify-content-center border"
                      style={{ width: 36, height: 36 }}
                    ...
                    <a
                      href="https://www.instagram.com/gaurav_tandukar/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="btn btn-sm btn-light rounded-circle p-0 d-flex align-items-center justify-content-center border"
                      style={{ width: 36, height: 36 }}
