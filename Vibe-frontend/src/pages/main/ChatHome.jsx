...
export default function ChatHome() {
  ...
  return (
    <div className="d-flex min-vh-100 sage--bg text-dark" style={{ transition: "margin-left 0.2s ease" }}>
      <Sidebar />

      {/* Main Content Area: dynamically adjusted via Sidebar's useEffect */}
      <div
        id="main-content"
        className="flex-grow-1 d-flex flex-column justify-content-between p-4 p-md-5"
        ...
        >
          ...
          <div className="d-flex flex-wrap justify-content-center gap-3 mb-5">
            <button
              ...
              onClick={() => {
                // Focus the sidebar search input or trigger a search modal
          ...
          <div className="row g-3 text-start">
            ...
            <div className="col-12 col-md-4">
              <div className="card h-100 border-0 shadow-sm rounded-4 p-3 bg-white">
                ...
                <p className="small text-muted mb-0">
                  Click on the group icons on the far-left rail to switch
                  between servers and teams.
                </p>
              </div>
            </div>
